...
!function(e, t, n) {
    ...
    var o = n(0)
      ...
      , s = "nav-header-menu__bar"
      , a = "nav-header-menu__arrow--left"
      , l = "nav-header-menu__arrow--right"
      , c = function() {
        function e(t, n) {
            i(this, e),
            this.window = t,
            this.domUtils = new o.a(n),
            this.container = this.domUtils.findElementByClassName(s),
            this.leftArrow = this.domUtils.findElementByClassName(a),
            this.rightArrow = this.domUtils.findElementByClassName(l),
        ...
        return r(e, [{
            ...
            value: function() {
                ...
                return function() {
                    var n = e.container.scrollWidth - e.container.clientWidth
                      , i = e.container.scrollLeft
                      , o = i + t * e.container.clientWidth * .9
                      , r = Math.min(Math.max(o, 0), n);
                    e.window.opbox.tween(i, r, e.scrollTo)
                }
            }
        }, {
            key: "scrollTo",
            ...
            key: "render",
            value: function() {
                var t = this.container.scrollWidth - this.container.clientWidth;
                e.renderArrow(this.leftArrow, this.container.scrollLeft > 0),
                e.renderArrow(this.rightArrow, this.container.scrollLeft - t < 0)
            }
        }, {
            key: "initialize",
            value: function() {
                this.container && (this.render(),
                this.domUtils.addListener(this.container, "scroll", this.render),
                this.domUtils.addListener(this.window, "resize", this.render),
                this.domUtils.addListener(this.leftArrow, "click", this.move(-1)),
                this.domUtils.addListener(this.rightArrow, "click", this.move(1)))
            }
        }], [{
            key: "renderArrow",
            value: function(e, t) {
                e && t && e.classList.contains("is-hidden") ? e.classList.remove("is-hidden") : !e || t || e.classList.contains("is-hidden") || e.classList.add("is-hidden")
            }
        }]),
        e
    }()
