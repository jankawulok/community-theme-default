              ...
              {if $is_logged}
                {if !$comment.customer_advice}
                  <li>
                    ...
                    <button class="usefulness_btn btn btn-sm btn-link" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
                      <i class="icon icon-thumbs-up"></i> {l s='Yes' mod='productcomments'}
                    </button>
                    <button class="usefulness_btn btn btn-sm btn-link" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
                ...
                {if !$comment.customer_report}
                  <li>
                    <a href="#" class="report_btn btn btn-sm btn-link" data-id-product-comment="{$comment.id_product_comment}">
